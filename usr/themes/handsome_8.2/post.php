...
:?>
    ...
    $data['type'] = "category";
    $data['category_mid'] = $this->stack[0]['categories'][0]['slug'];
    $data['img'] = @$rData['img'];
    $_GET['data']=$data;
       ...
       <div id="postpage" class="blog-post">
        ...
        <?php if (!Content::isImageCategory($this->categories)) echo Content::exportHeaderImg($this); ?>
         ...
         <div id="post-content" class="wrapper-lg">
             ...
             <?php if (!empty($this->options->featuresetup) && in_array('payforauthorinpost', Utils::checkArray( $this->options->featuresetup))): ?>
                 <!--打赏模块-->
